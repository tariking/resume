...
職務中ですが契約終了を控え**求職中です**。2020年4月以降の新しい職場を探しています:sparkles:
<br>
<br>
...
@tarikingはフリーランスのWebフロントエンジニアです。IT業界には新卒以降20年程度携わっています。  
 - 直近業務ではJavaScript(ES6)+ReactJS+Redux(saga)を使用して4年ほど経過しました。ほかに長いものはPHP(cakePHPその他)で8年程度業務経験があります。  
 - かつてはバックエンドエンジニアだったので、基本的なサーバ、若干のネットワーク、DBの知識があります。  
 - 顧客折衝、画面デザイン、各種設計とドキュメント整備、開発、テスト、顧客教育、社内新人教育など一通り経験しています。  
 - 現場ではWebフロントの要件定義、設計、UI/UX設計などをやりながら、プログラミング+デザイン(デザイナー補助)を同時並行することが多いです。
<br>
<br>

## 希望

直近はJSプログラマです。1年前まではPM,PLもしくは設計工程全般をこなしてきました。<br>
今後の希望はエンジニア：プログラマとしてコーディングの比重を増やしたいと思っています。<br>
自己学習レベルですが、`angular` `Pyson` `機械学習` `AI` `VR` をキーワードに情報を集めており、実務の現場に入りたいと考えています。<br>
最近はプログラム学習ではなく、高校数学を学び直し中です。<br>
レガシーの保守よりも、新しい技術に触れたいです。
<br>
長時間の電車移動が苦手なので(酔います)、リモートワークが可能であれば積極的に利用したいです。
<br>
<br>

## 直近の職務経歴

#### 2019/10 - 現在 : 東急電鉄の保線要員向けのiPad対応開発　フロント開発<br>[ポジション]プログラマ、一部テスター
