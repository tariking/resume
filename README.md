...
直近はJSプログラマです。1年前まではPM,PLもしくは設計工程全般をこなしてきました。
今後の希望はエンジニア：プログラマとしてコーディングの比重を増やしたいと思っています。
自己学習レベルですが、`angular` `Pyson` `機械学習` `AI` `VR` をキーワードに情報を集めており、実務の現場に入りたいと考えています。
最近はプログラム学習ではなく、高校数学を学び直し中です。
