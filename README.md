...
s45.rita☆gmail.comに連絡いただけると幸いです。
<br>
<br>
<br>
...
@tarikingは現在Webフロントエンジニアです。IT業界には20年程度携わっています。  
<br>
直近業務では主にJavaScript(TypeScript)+React-reduxを4年ほど使用しています。ほかに長いものはPHPで8年程度業務経験があります。  
...
できればエンジニアとしてコーディングメインでやっていきたいと思っています。  
自己学習レベルですが、`angular` `Pyson` `機械学習` `AI` `VR` をキーワードに情報を集めており実務の現場を体験したいと思っています。
